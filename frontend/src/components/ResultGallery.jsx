...
import { Download, CheckCircle2, RotateCcw, AlertTriangle, ExternalLink, Sparkles, HeartHandshake, X } from 'lucide-react';
    ...
    <div className="w-full max-w-3xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-end gap-2">
        ...
        <button
          ...
          className="bg-white hover:bg-amber-50 text-amber-700 border border-amber-200 font-bold py-3 px-5 rounded-xl shadow-sm hover:shadow-md transition-all-custom flex items-center justify-center gap-2 text-sm"
        >
          <HeartHandshake size={18} />
          <span>Support Free Tool</span>
        </button>
      </div>
          ...
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h4 className="font-bold text-slate-800">Support Free School Tools</h4>
                  <p className="text-[11px] text-slate-400">Your support helps SBZ Tech keep this service free.</p>
                </div>
              </div>
              <button
