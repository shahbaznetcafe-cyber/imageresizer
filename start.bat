...
start "PECTAA Backend" cmd /k "cd /d ""%APP_ROOT%"" && "".venv\Scripts\python.exe"" -m uvicorn backend.main:app --reload --host 127.0.0.1 --port 8000"

echo Starting frontend on http://127.0.0.1:5173
start "PECTAA Frontend" cmd /k "cd /d ""%APP_ROOT%frontend"" && set ""VITE_API_URL=http://127.0.0.1:8000"" && npm.cmd run dev -- --host 127.0.0.1"
